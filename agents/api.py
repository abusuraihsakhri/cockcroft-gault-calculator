"""
FastAPI REST API Server for Cockcroft Gault Calculator.
"""
...
app = FastAPI(
    title="Cockcroft Gault Calculator API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "cockcroft-gault-calculator", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
