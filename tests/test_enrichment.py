"""
Automated Pytest for cockcroft-gault-calculator Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    DialysisAdequacyPredictionKtvTrajectoryEngine,
    RenalTransplantWorkupChecklistAutomationEngine,
    RequiredAllPatientsEngine,
    AgeadjustedEngine,
    ComorbidityadjustedEngine,
    CockcroftgaultcalculatorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = CockcroftgaultcalculatorEnrichmentSuite()
